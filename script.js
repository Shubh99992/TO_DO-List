...
function CreateToDoItems() {
    ...
    const todoItems = `<div title="Hit Double Click and Complete" ondblclick="CompletedToDoItems(this)">${todoValue.value}</div><div>
                    <img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="https://png.pngtree.com/element_our/png/20181226/pencil-line-black-icon-png_281626.jpg" />
                    <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="https://cdn-icons-png.flaticon.com/128/3976/3976961.png" /></div></div>`;
